...
function buildMockDB() {
  ...
  leads.push(
    ...
    { id: 'lead-002', name: 'Ben Cruz', contact: '09192222222', level: 'College', program: 'BS Computer Science', school: 'FEU', service_interest: 'Regular — RRLs', source: 'Main Page', referred_by: '', notes: 'Needs 20 RRLs for thesis. Budget: 5-8k', status: 'Contacted', follow_up_date: '2026-03-22', created_by: USERS.ops.id, created_by_name: USERS.ops.full_name, created_at: '2026-03-08T10:00:00Z' },
